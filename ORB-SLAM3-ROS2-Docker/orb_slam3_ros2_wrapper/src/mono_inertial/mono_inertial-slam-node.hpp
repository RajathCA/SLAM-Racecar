/**
 * @file mono_inrtial-slam-node.hpp
 * @brief Definition of the RgbdSlamNode Wrapper class.
 * @author Suchetan R S (rssuchetan@gmail.com)
 */

#ifndef MONO_INERTIAL_SLAM_NODE_HPP_
#define MONO_INERTIAL_SLAM_NODE_HPP_
...
namespace ORB_SLAM3_Wrapper
{
    ...
    {
    public:
        MonoInertialSlamNode(const std::string &strVocFile,
...
#endif // MONO_INERTIAL_SLAM_NODE_HPP_
