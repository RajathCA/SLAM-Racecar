...
#---------------------------------------------
    ...
    def all_nodes_launch(context, robot_namespace, robot_x, robot_y):
        ...
        config_file_path = "/home/orb/ORB_SLAM3/Examples/Monocular-Inertial/raymond_left.yaml"
        declare_params_file_cmd = DeclareLaunchArgument(
            'params_file',
            default_value=os.path.join(orb_wrapper_pkg, 'params', 'mono-init-ros-params.yaml'),
            description='Full path to the ROS2 parameters file to use for all launched nodes')
        print(f"PATH USED: {os.path.join(orb_wrapper_pkg, 'params', 'mono-init-ros-params.yaml')}")
        print(declare_params_file_cmd)
        base_frame = ""
